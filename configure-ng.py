...
def check_modules(target_config, verbose):
    ...
    check_module(target_config, verbose, 'QtNetwork', 'qhostaddress.h',
            'new QHostAddress()')
    check_module(target_config, verbose, 'QtDeclarative', 'qdeclarativeview.h',
...
''')
    ...
    if 'QtXml' in target_config.modules:
...
def check_qt(target_config):
    ...
    if target_config.qt_version < 0x040100:
        error("PyQt4 requires Qt v4.1.0 or later.")
